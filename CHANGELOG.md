...
* build(deps): Bump dependabot/fetch-metadata from 3.0.0 to 3.1.0 by @dependabot[bot] in https://github.com/DevWizardHQ/laravel-textify/pull/23
* build(deps): Update guzzlehttp/guzzle requirement from ^7.0 to ^8.2 by @dependabot[bot] in https://github.com/DevWizardHQ/laravel-textify/pull/27
* build(deps): Bump actions/checkout from 6 to 7 by @dependabot[bot] in https://github.com/DevWizardHQ/laravel-textify/pull/24
* chore(deps): allow guzzlehttp/guzzle ^8.0 by @iqbalhasandev in https://github.com/DevWizardHQ/laravel-textify/pull/28

**Full Changelog**: https://github.com/DevWizardHQ/laravel-textify/compare/v1.6.1...v1.6.2
...
* fix: address review feedback on SKILL.md documentation by @iqbalhasandev in https://github.com/DevWizardHQ/laravel-textify/pull/16

**Full Changelog**: https://github.com/DevWizardHQ/laravel-textify/compare/v1.5.0...v1.5.1
...
* chore(deps): configure local laravel-textify package for development and fix method chaining by @iqbalhasandev in https://github.com/DevWizardHQ/laravel-textify/pull/12
* build(deps): Bump actions/checkout from 5 to 6 by @dependabot[bot] in https://github.com/DevWizardHQ/laravel-textify/pull/9
* fix(bulk-sms): assign textify instance after setting sender to maintain method chain by @iqbalhasandev in https://github.com/DevWizardHQ/laravel-textify/pull/13

**Full Changelog**: https://github.com/DevWizardHQ/laravel-textify/compare/v1.4.0...v1.4.1

## v1.4.0 - 2025-10-27

### What's Changed

* fix: update ReveSMS provider URIs to use HTTP instead of HTTPS by @iqbalhasandev in https://github.com/DevWizardHQ/laravel-textify/pull/8

**Full Changelog**: https://github.com/DevWizardHQ/laravel-textify/compare/v1.3.1...v1.4.0
